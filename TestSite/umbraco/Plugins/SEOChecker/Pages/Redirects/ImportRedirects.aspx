...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    <umbraco:UmbracoPanel ID="UmbracoPanel" runat="server">
        <umbraco:Feedback ID="SEOCheckerImportProviderWarnings" runat="server" type="notice" Visible="false" />
         ...
         <asp:CustomValidator runat="server" ID="ImportValidator" ControlToValidate="ImportTypeDropdownList" CssClass="hidden" ValidateEmptyText="True" OnServerValidate="ImportValidator_OnServerValidate" Display="Dynamic"></asp:CustomValidator>
        ...
        <asp:PlaceHolder runat="server" ID="ImportFormPlaceHolder">
            ...
            <asp:PlaceHolder runat="server" ID="AdditionalImportOptionsPlaceholder">
                <asp:PlaceHolder runat="server" ID="FieldMappingPlaceHolder">
